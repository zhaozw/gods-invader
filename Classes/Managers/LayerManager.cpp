...
void LayerManager::sortChildrenByYPosition() // TODO: Code refactoring.
{
	...
	for(int j = 0; j < length; j++)
	{
		...
		for(i = j - 1; i >= 0 && ((Entity*) this->getChildren()->objectAtIndex(i))->getCenterY() < testValue->getCenterY() && !testValue->isSetAsShadow() && !((Entity*) this->getChildren()->objectAtIndex(i))->isIgnoreSorting(); i--)
		{
